      ...
      <View style={styles.content}>
        ...
        <View style={styles.form}>
          ...
          <View style={styles.divider}>
            ...
            <Text style={[styles.dividerText, { color: Colors[colorScheme ?? 'light'].textSecondary }]}>or</Text>
            <View style={[styles.dividerLine, { backgroundColor: Colors[colorScheme ?? 'light'].border }]} />
          </View>
          
          <TouchableOpacity 
            style={[styles.anonymousButton, { borderColor: Colors[colorScheme ?? 'light'].border }]}
            onPress={handleAnonymousLogin}
          >
            <Text style={[styles.anonymousButtonText, { color: Colors[colorScheme ?? 'light'].text }]}>
              Continue as Guest
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.signupContainer}>
          <Text style={[styles.signupText, { color: Colors[colorScheme ?? 'light'].textSecondary }]}>
            Don&apos;t have an account?
          </Text>
          <TouchableOpacity onPress={() => router.replace('/auth/signup')}>
            <Text style={[styles.signupLink, { color: Colors[colorScheme ?? 'light'].primary }]}>Sign Up</Text>
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
