...
"[project]/lib/generated/prisma/runtime/library.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
"[project]/lib/generated/prisma/index.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
;
const db = globalThis.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["PrismaClient"]();
if ("TURBOPACK compile-time truthy", 1) {
...
"[project]/lib/checkUser.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const checkUser = async ()=>{
    ...
    const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$nextjs$2f$dist$2f$esm$2f$app$2d$router$2f$server$2f$currentUser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["currentUser"])();
    ...
    try {
        ...
        const loggedInUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].user.findUnique({
            where: {
                clerkUserId: user.id
            }
        });
        ...
        const newUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].user.upsert({
            where: {
                email
            },
            update: {
        ...
        if (error.code === 'P2002') {
            ...
            const conflictingUser = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["db"].user.findFirst({
                where: {
                    OR: [
                        {
                            clerkUserId: user.id
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$checkUser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/checkUser.js [app-ssr] (ecmascript)");
"use client";
;
;
;
...
;
const Header = async ()=>{
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$checkUser$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["checkUser"])();
    ...
    const { isLoaded, session } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$shared$2f$dist$2f$react$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSession"])();
    ...
    useEffect(()=>{
        ...
        // Check if the user just signed in/up by looking at the session
        if (session) {
            // Check if this is a new session (recent sign-in/sign-up)
            const isNewSession = session.createdAt && Date.now() - session.createdAt.getTime() < 5000; // 5 seconds threshold
            if (isNewSession) {
                toast.success(`Welcome ${session.user.firstName || ''}! You've signed in successfully.`, {
                    duration: 3000
                });
                setTimeout(()=>{
                    toast.info("Check out Industry Insights tailored to your skills and bio!", {
                        duration: 4000
                    });
                }, 1500);
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f46e85f9._.js.map